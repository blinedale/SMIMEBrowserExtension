...
// read comodo CA
const certificateBuffer = stringToArrayBuffer(window.atob(getComodoRootCert().replace(/(-----(BEGIN|END)( NEW)? CERTIFICATE-----|\n)/g, "").replace(/\n/g, "\r\n")));
...
smimeVerificationService.setRootCert(certificate);
