const smimeSpecificationConstants = {
  signatureNodeContentTypeValues: ["application/pkcs7-signature", "application/x-pkcs7-signature"],
  rootNodeContentTypeValue: "multipart/signed",
  rootNodeContentTypeProtocol: ["application/pkcs7-signature", "application/x-pkcs7-signature"],
